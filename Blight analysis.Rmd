...
The aim of this analysis is to build a model, which will predict the risk of blight for certain building/geo coordinates located in Detroit.
...
featurise <- function(df, radius, precision, spread_col){
...
# m9 <- xgboost(data=xgb_tr, label=lb, nrounds = 100, eta=8/100, 
#               max_depth=15, eta=0.8,
#                      gamma=1, colsample_bytree=0.8,
#                      subsample=0.75, min_child_weight=2,
#               objective = "binary:logistic")
# 
# importance <- xgb.importance(feature_names=dimnames(tr)[[2]], model=m9)
